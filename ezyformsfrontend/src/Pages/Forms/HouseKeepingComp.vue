                        ...
                        <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        ...
                                        <FormFields class="mb-3" tag="input" type="search" name="Requested"
                                            id="Requested" placeholder="Search" v-model="search" />
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <FormFields class="mb-3" tag="input" type="date" name="Requested" id="Requested"
                                            placeholder="Jan-2024-Dec-2024" v-model="search" />
                                    </div>
                                    <div class="col-3"></div>
                                    <div class="col-3">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn font-12" data-bs-dismiss="modal">Cancel
                                    Filter</button>
                                <button type="button" class="btn btn-primary font-12">Apply Filter</button>
                            </div>
                        </div>
                    </div>
                </div>
