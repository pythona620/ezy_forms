                      ...
                      <div class="stepperbackground ps-2 pe-2 m-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                          ...
                          <button v-if="blockArr.length" class="btn btn-dark font-10 Withborder border" type="button"
                            ...
                            {{ paramId !== "new" && isDuplicate !== '1' ? "Update Form" : "Create Form" }}
                          </button>
                          ...
                          <div class="requestandAppHeader">
                            <div class="d-flex justify-content-between align-items-center">
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                <button v-if="blockIndex!==0" class="btn btn-light bg-transparent border-0 font-13 deleteBlock"
                                  @click="confirmDelete(blockIndex)">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content rounded-3 border-0">
      <div class="modal-header border-0">
        <h5 class="modal-title" id="deleteBlockModalLabel">Delete Confirmation</h5>
        <button
          type="button"
          class="btn-close"
    ...
    <div class="offcanvas addOffCanvas offcanvas-end" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" id="offcanvasRight"
      ...
      <div class="offcanvas-header add_designationHeader">
        ...
        <button type="button" @click="clearDesignationSelect()" class="btn-close bg-light text-reset" data-bs-dismiss="offcanvas"
...
function clearall_designations() {
  ...
  if (designationSelect.value) {
    designationSelect.value.search = ""; // clear search text
  }
}

function clearDesignationSelect() {
  // Clear search text
  if (designationSelect.value) {
    designationSelect.value.search = "";
  }
}
// const isAllSelected = computed(() => {
...
const designationSelect = ref(null);
...
function addDesignationBtn() {
  ...
  add_Wf_roles_setup();
// Only clear the search text (keep selected items)
  if (designationSelect.value) {
    designationSelect.value.search = "";
  }
...
const confirmDelete = (index) => {
  ...
  if (index === 0) {
    selectedBlockName.value = "Request Block";
  } else {
    selectedBlockName.value = blockArr[index]?.name || `Approver Block ${index}`;
  }
...
const confirmDeleteBlock = () => {
  if (selectedBlockIndex.value !== null) {
    removeBlock(selectedBlockIndex.value);
...
const removeBlock = (blockIndex) => {
  ...
  if(rolesToDelete.length){
    ...
    showSuccess(`Approver Block ${blockIndex} deleted successfully!`);
  }
