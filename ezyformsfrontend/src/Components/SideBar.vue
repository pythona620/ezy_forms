...
const settingsSideBarData = [
    ...
    { name: 'System Settings', icon: 'bi bi-gear', route: 'authenticationpage' },
    ...
    { name: 'Form Templates', icon: 'bi bi-envelope-paper', route: 'predefinedforms' },
    // { name: 'Vendor Comparison', icon: 'bi bi-file-earmark-text', route: 'vendorcomparison' },
    { name: 'Acknowledgement' , icon: 'bi bi-clipboard2-check', route: 'acknowledgement' },
