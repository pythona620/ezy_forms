<template>
                      ...
                      <div v-if="field.fieldtype !== 'Table'" :class="field.fieldtype === 'Check' ? 'w-0' : 'w-100'">
                       ...
                       <template v-else-if="field.fieldtype == 'Attach'">
                              ...
                              <input
                                ...
                                :disabled="props.readonlyFor === 'true' || blockIndex === 0"
                                type="file"
  ...
  @mouseleave="hovered[`${field.fieldname}-${index}`] = false"
                                ...
                                >
                                  ...
                                  <!-- Remove Button -->
                                  <button v-if="hovered[`${field.fieldname}-${index}`] && props.readonlyFor !== 'true' && blockIndex !== 0"
                        ...
                        <template v-else-if="field.fieldtype === 'Link' && field.fieldname !== 'department_name' && field.fieldname !== 'designation'">
                            ...
                            <input v-if="readonlyFor !== 'true'" type="text" :value="field.value"
...
<span class=" font-12 m-0">
  {{ field.value }}
                        ...
                        <template v-else>
                          ...
                          <template
                            v-if="blockIndex === 0 && field.fieldtype !== 'Int' && field.fieldtype !== 'Text' && field.fieldtype !== 'Select' && field.fieldname !== 'auto_calculations' || props.readonlyFor === 'true' ">
                            <span style="font-size: 12px;"
                              :class="props.readonlyFor === 'true' || blockIndex < currentLevel ? 'border-0  w-50 bg-transparent' : ''"
                              :value="field.value" :type="field.fieldtype">
                              {{ field.fieldtype === 'Time' ? formatTime(field.value) : field.value }}
                                    ...
                                    <td v-for="field in headers" :key="field.fieldname" :style="field.label !== 'Type of Manpower'
                                      ...
                                      <!-- <template v-if="isFilePath(row[field.fieldname])">
                                       ...
                                       <template v-if="field.fieldtype === 'Attach'">
                                          ...
                                          <div v-if="row[field.fieldname]" class="d-flex flex-column align-items-center gap-1 mt-2">
                                            <div
                                            ...
                                            >
                                              ...
                                              <button
                                                v-if="props.readonlyFor !== 'true' && blockIndex === currentLevel"
                                        ...
                                        <template v-if="field.fieldtype === 'Text'">
                                          <textarea v-if="props.readonlyFor !== 'true' && blockIndex !== 0 && blockIndex == currentLevel" type="text"
                                            :class="blockIndex === 0 || props.readonlyFor === 'true' || blockIndex < currentLevel ? 'bg-white border-0' : null"
                                            :disabled="blockIndex === 0 || props.readonlyFor === 'true' || blockIndex < currentLevel"
                                            class="form-control form-control-sm font-12 text-center"
                                            v-model="row[field.fieldname]"
                                  ...
                                  <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        <button type="button" data-bs-dismiss="modal" style="position: absolute; top: 10px; right: 10px; border: none; background: transparent; font-size: 20px;"> &times;</button>
                                      </div>
                                      <div class="modal-body text-center">
                                        <div class="d-flex justify-content-between align-items-center">
                                          ...
                                          <div v-if="showPreview" class="preview-area mt-2">
                                            <img v-if="isImageFile(previewFile)" :src="previewFile" class="img-fluid border rounded" style="max-width: 100%;" />
                                            <iframe v-else-if="isPdfFile(previewFile)" :src="previewFile" width="100%" height="500px" style="border:1px solid #ccc;"></iframe>
                                            <div v-else class="text-center">
                                              <p>Preview not available for this file type. <a :href="previewFile" target="_blank">Download</a></p>
                                            </div>
                                          </div>
                                      </div>
                                    </div>
