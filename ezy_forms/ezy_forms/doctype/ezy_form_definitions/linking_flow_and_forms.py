...
def enqueing_creation_of_roadmap(doctype:str,property_name:str,bulk_request:bool,workflow_setup:list[dict]):
	try:
		...
		frappe.db.commit()
		if workflow_setup:
			add_roles_to_wf_requestors(business_unit=property_name, doctype=doctype, workflow_setup=workflow_setup)
