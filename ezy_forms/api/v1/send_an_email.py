			...
			for email in user_emails:
				...
				try:
					...
					frappe.sendmail(
						...
						content = email_content['email_template'] + ("<b>Note: </b>Since the file size is more than 30MB, please refer to the attachments in the form." if  file_down and file_down['file_size'] else '') if email_content['email_template'] else '',
